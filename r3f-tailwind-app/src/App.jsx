...
function FurnitureThumbnail({ item }) { const category = item.category.replace('-', ' '); return <div className={`furniture-thumb-preview furniture-thumb-${item.category}`} aria-label={`${item.name} preview`}><div className="furniture-thumb-object" aria-hidden="true"><span className="furniture-thumb-surface" /><span className="furniture-thumb-form" /></div><div className="furniture-thumb-meta"><span>{category}</span><b>PREVIEW</b></div></div>; }
