...
function LayoutContent({ room, setRoomAppearance }) {
  ...
  const structures = useStore((s) => s.structures); const selectedIds = useStore((s) => s.selectedIds);
  ...
  const [tab, setTab] = useState('Room Types'); const [isAddRoomOpen, setIsAddRoomOpen] = useState(false); const [roomName, setRoomName] = useState(''); const selected = structures.find((item) => selectedIds.includes(item.id));
