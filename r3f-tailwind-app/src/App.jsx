...
function EditorRoute() {
  return <main style={{ minHeight: '100vh', background: '#121313' }}><a href="/" style={{ position: 'fixed', zIndex: 2, top: 20, left: 20, color: '#d7ad6b', fontFamily: 'DM Mono, monospace', fontSize: 12 }}>← Back to IntelliSpace</a><SceneCanvas /></main>
}

function App() {
  if (window.location.pathname === '/editor') return <EditorRoute />
  ...
  return <main className="landing-shell">
    <header className="site-nav">
      ...
      <nav className={menuOpen ? 'nav-links is-open' : 'nav-links'} aria-label="Primary navigation">
        ...
        <a className="mobile-start" href="/editor" onClick={() => setMenuOpen(false)}>Get Started <ArrowRight size={14} /></a>
      </nav>
      <div className="nav-actions"><a className="login-link" href="#about">Log In</a><a className="button button-small" href="/editor">Get Started <ArrowRight size={14} /></a></div>
    ...
    <section className="hero" id="top">
      <div className="hero-copy">
        ...
        <div className="hero-actions"><a href="/editor" className="button">Start Designing <ArrowRight size={16} /></a><a href="#how-it-works" className="text-link"><span className="play-icon"><Play size={10} fill="currentColor" /></span> Explore the experience</a></div>
      </div>
    ...
    <section className="final-cta" id="start"><p className="section-index">BEGIN WITH A ROOM</p><h2>Bring your space<br /><em>to life.</em></h2><a href="/editor" className="button">Start Designing <ArrowRight size={16} /></a></section>
